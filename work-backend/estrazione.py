...
app.config["MONGO_URI"] = "mongodb+srv://Goyco2:<password>@cluster0.xessbxz.mongodb.net/?retryWrites=true&w=majority" #Importante qui va specificato il nome del DB
